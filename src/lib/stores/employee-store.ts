...
// Family member factory - applies sensible defaults for new fields
function fm(
  id: string, employee_id: string, name: string, relation: string,
  birth_date: string | null, phone: string | null, is_dependent: boolean,
  extra?: Partial<Pick<FamilyMember, 'is_living_together' | 'has_income' | 'medical_notes'>>,
): FamilyMember {
  // 배우자/자녀는 보통 동거, 부모는 부양시 동거 가정
  const defaultLiving = relation === '배우자' || relation === '자녀';
  return {
    id, employee_id, name, relation, birth_date, phone, is_dependent,
    is_living_together: extra?.is_living_together ?? defaultLiving,
    has_income: extra?.has_income ?? !is_dependent,
    medical_notes: extra?.medical_notes ?? null,
  };
}

const seedFamilyMembers: FamilyMember[] = [
  fm('fm-01', 'e001', '이미자', '배우자', '1960-08-15', '010-1234-0001', true),
  fm('fm-02', 'e001', '이지영', '자녀', '1985-04-20', null, false),
  fm('fm-03', 'e002', '김선영', '배우자', '1967-02-10', '010-1234-0002', true),
  fm('fm-04', 'e004', '박현정', '배우자', '1972-09-22', '010-1234-0004', true),
  fm('fm-05', 'e004', '김민서', '자녀', '2002-03-15', null, true),
  fm('fm-06', 'e010', '이준혁', '배우자', '1984-06-30', '010-1234-0010', false),
  fm('fm-07', 'e013', '박성진', '배우자', '1982-04-11', '010-1234-0013', false),
  fm('fm-08', 'e013', '장서윤', '자녀', '2012-07-05', null, true),
  fm('fm-09', 'e015', '김미영', '배우자', '1984-03-20', '010-1234-0015', true),
  fm('fm-10', 'e016', '최은주', '배우자', '1973-11-28', '010-1234-0016', true),
  fm('fm-11', 'e016', '강현서', '자녀', '2005-01-10', null, true),
  fm('fm-12', 'e017', '이수연', '배우자', '1981-07-15', '010-1234-0017', true),
  fm('fm-13', 'e017', '윤지원', '자녀', '2010-09-03', null, true),
  fm('fm-14', 'e019', '김유진', '배우자', '1986-05-18', '010-1234-0019', true),
  fm('fm-15', 'e021', '박은경', '배우자', '1974-08-25', '010-1234-0021', true),
  fm('fm-16', 'e021', '송현우', '자녀', '2003-06-12', null, true),
  fm('fm-17', 'e021', '송다인', '자녀', '2006-11-20', null, true),
  fm('fm-18', 'e022', '최수빈', '배우자', '1983-12-05', '010-1234-0022', true),
  fm('fm-19', 'e024', '이정은', '배우자', '1978-04-30', '010-1234-0024', true),
  fm('fm-20', 'e024', '권서준', '자녀', '2008-02-14', null, true),
  fm('fm-21', 'e025', '김보영', '배우자', '1979-10-08', '010-1234-0025', true),
  fm('fm-22', 'e026', '정혜진', '배우자', '1975-06-17', '010-1234-0026', true),
  fm('fm-23', 'e027', '박미선', '배우자', '1984-09-12', '010-1234-0027', true),
  fm('fm-24', 'e028', '이수정', '배우자', '1985-11-30', '010-1234-0028', true),
  fm('fm-25', 'e029', '김현주', '배우자', '1982-07-22', '010-1234-0029', true),
  fm('fm-26', 'e030', '이미래', '배우자', '1980-03-05', '010-1234-0030', true),
  fm('fm-27', 'e030', '서하준', '자녀', '2010-05-18', null, true),
  fm('fm-28', 'e031', '박소라', '배우자', '1986-12-25', '010-1234-0031', true),
  fm('fm-29', 'e041', '김태연', '배우자', '1988-02-22', '010-1234-0041', true),
  fm('fm-30', 'e051', '이현아', '배우자', '1981-10-15', '010-1234-0051', true),
  fm('fm-31', 'e057', '박정아', '배우자', '1986-03-08', '010-1234-0057', true),
  fm('fm-32', 'e063', '최미정', '배우자', '1981-07-20', '010-1234-0063', true),
  fm('fm-33', 'e063', '김태준', '자녀', '2010-12-01', null, true),
  fm('fm-34', 'e068', '한지혜', '배우자', '1982-05-09', '010-1234-0068', true),
  fm('fm-35', 'e073', '신미영', '배우자', '1986-08-14', '010-1234-0073', true),
  fm('fm-36', 'e081', '오세미', '배우자', '1987-04-20', '010-1234-0081', true),
  fm('fm-37', 'e088', '이민수', '배우자', '1985-09-10', '010-1234-0088', false),
  fm('fm-38', 'e092', '조은정', '배우자', '1977-12-08', '010-1234-0092', true),
  fm('fm-39', 'e092', '이서현', '자녀', '2007-06-25', null, true),
  fm('fm-40', 'e096', '김정민', '배우자', '1978-11-03', '010-1234-0096', true),
  fm('fm-41', 'e103', '윤미라', '배우자', '1985-01-22', '010-1234-0103', true),
];
